...
public class WindowFrameTAbTest {

    @Test
    void switchToTabTest() {
        webDriver.get("https://www.ozon.ru/browser-windows");
    ...
    void switchToFrameTest() {
        webDriver.get("https://www.ozon.ru/frames");
    ...
    void alertAcceptTest() throws InterruptedException {
        webDriver.get("https://www.ozon.ru/alerts");
